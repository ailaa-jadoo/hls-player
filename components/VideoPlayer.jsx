        ...
        const handleKeyDown = (e) => {
            ...
            switch (e.key) {
                ...
                case '-':
                    // Decrease speed
                    setPlaybackRate(prevRate => {
                        const prevIndex = speedOptions.slice().reverse().findIndex(speed => speed < prevRate);
                        return prevIndex !== -1 ? speedOptions[speedOptions.length - 1 - prevIndex] : prevRate;
                    });
                    e.preventDefault();
                    break;
                case '0':
        ...
        <div className="video-player-container rounded-lg overflow-hidden bg-gray-900 shadow-xl">
            ...
            >
                ...
                {loadingStatus !== 'success' && (
                    <div className={`absolute top-4 left-4 right-4 z-20 ${statusInfo.bgColor} ${statusInfo.textColor} border ${statusInfo.borderColor} rounded-lg p-2 bg-opacity-90 flex items-center`}>
                        ...
                        <div className="flex items-center mb-2">
                            ...
                            <div className="flex-grow relative">
                                <input
                                    ...
                                    style={{
                                        backgroundImage: `linear-gradient(to right, rgb(59, 130, 246) 0%, rgb(59, 130, 246) ${(currentTime / (duration || 1)) * 100}%, rgb(75, 85, 99) ${(currentTime / (duration || 1)) * 100}%, rgb(75, 85, 99) 100%)`
                                    }}
                                />
                            </div>
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <div className="relative">
                                    <button 
                                        ...
                                        className="flex items-center px-2 py-1 text-white text-xs font-medium hover:bg-gray-700 rounded"
                                    >
                                        {playbackRate}x
                                        <svg className={`w-4 h-4 ml-1 transform transition-transform ${showSpeedControls ? 'rotate-180' : ''}`} fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd" />
                                        </svg>
                                    </button>
                                    
                                    {showSpeedControls && (
                                        <div className="absolute bottom-full right-0 mb-1 p-2 bg-gray-800 rounded shadow-lg z-30">
                                            <div className="flex justify-between items-center mb-2">
                                                ...
                                                <div className="text-xs font-medium text-white">Speed</div>
                                                <button 
                                            ...
                                            <div className="mt-2 text-xs text-gray-400 text-center">
                                                Keyboard: <span className="bg-gray-700 px-1 rounded">-</span> / <span className="bg-gray-700 px-1 rounded">+</span> to change, <span className="bg-gray-700 px-1 rounded">0</span> to reset
                                            </div>
                                        </div>
                                    )}
                                </div>
            ...
            <div className="p-2 bg-gray-800 border-t border-gray-700 text-xs text-gray-400 rounded-b-lg mt-1">
                <div className="flex flex-wrap justify-between">
                    <div className="flex items-center mr-4 mb-1">
                        <span className="bg-gray-700 px-1.5 py-0.5 rounded mr-1">Space</span>
